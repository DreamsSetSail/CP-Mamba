...
class SemData(Dataset):
    def __init__(self, split=3, shot=1, data_root=None, base_data_root=None, data_list=None, data_set=None,
                 ...
                 ft_transform=None, ft_aug_size=None, return_meta=False):
        ...
        if self.mode == 'train':
            ...
            if self.return_meta:
                meta = {
                    ...
                    'query_label_path': label_path,
                    'support_image_paths': support_image_path_list,
                    'support_label_paths': support_label_path_list,
                    'class_chosen': int(class_chosen),
                    'raw_image': raw_image,
                    'raw_label': raw_label,
                    'support_images_ori': support_image_list_ori,
                    'support_labels_ori': support_label_list_ori,
                }
                return image, label, s_x, s_y, subcls_list, raw_label, meta
